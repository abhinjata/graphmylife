...
description: >
  An analysis of how Princess Mononoke grounds gods, curses, and spirits in a
  tangible world to draw a sharp boundary between material reality and
  metaphysical belief, then uses that world to examine industrial ambition,
  ecological survival, and the possibility of cooperation.

summary: >
  Princess Mononoke makes the supernatural concrete—gods, curses, spirits are
  observable facts inside the story’s world. That move lets the film contrast
  our material reality with myth while staging a conflict between Irontown’s
  imperial ambition (Lady Eboshi) and nature’s desperate self-preservation
  (Okkoto, Moro, San). Ashitaka stands for balance: minimizing harm and
  insisting on coexistence. The climax exposes human greed as the destabilizing
  force and leaves a sober, collaborative path forward.

cover:
  alt: "Ancient forest and industrial Irontown in tension"
  relative: false
  # If you have an image, add:
  # image: "cover.jpg"

params:
  era: "Late Muromachi (14th–16th c.)"
  setting_inspiration: "Yakushima (Shiratani Unsuikyo), Kagoshima Prefecture"
  thesis: >
    By making the metaphysical empirically visible, the film shows that in our
    world such claims don’t meet the same bar—so religion and myth read as
    literature—while the true material conflict is human expansion versus
    ecological survival.
  key_characters:
    - Ashitaka: "Mediator seeking balance despite a lethal, visible curse."
    - San (Princess Mononoke): "Human raised by Moro, drawn toward coexistence."
    - Moro: "Wolf goddess, guardian of the forest."
    - Lady Eboshi: "Industrial leader—care for outcasts, but extractive, imperial."
    - Okkoto: "Boar god driven by pride and desperation to defend the forest."
---
